...
> Enforce security requirements on developer devices before issuing credentials — disk encryption, firewalls, screen lock, endpoint protection, and history-aware policies for rate limiting and step-up.

Source: https://vouch.sh/docs/device-posture/
