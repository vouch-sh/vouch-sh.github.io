...
> Build an MCP remote server with Vouch OIDC bearer token authentication using the Python FastMCP SDK.

Source: https://vouch.sh/docs/applications/mcp-server-py/
