...
> Major features and improvements in recent Vouch releases: explicit AWS profile selection, in-process server config bootstrap, credential and key lifecycle audit events, OIDC role pinning, per-organization issuers, post-quantum TLS, and more.
